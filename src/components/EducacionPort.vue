...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Incumbencias Profesionales: Operación y programación de computadoras, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.', enlace:'https://www.frsr.utn.edu.ar/programacion/'},
  {fecha: '2022', title: 'Testing QA', descripcion: 'Python, HTML, manejo de bases de datos con lenguaje SQL, formación de análisis funcional y herramientas de usabilidad Web y experiencia de usuario (UX) con el fin de agregar habilidades relacionadas al puesto de Tester QA.', enlace:'https://www.educacionit.com/carrera-testing-qa'},
  {fecha: '2020', title: 'Letras Modernas - Portugués e Inglés', descripcion: 'La carrera de Letras Modernas con habilitación en Portugués e Inglés en la USP ofrece una formación sólida en estudios lingüísticos, literarios y culturales de los idiomas portugués e inglés. A lo largo de la licenciatura y el bacharelado, los estudiantes desarrollan habilidades en análisis crítico, traducción, docencia e investigación, además de profundizar en la literatura y la lingüística de ambos idiomas. Esta carrera prepara a los graduados para trabajar en diversos campos, como la enseñanza, la traducción, la edición y la investigación, con un enfoque integral en la teoría y práctica de la lengua y la literatura.', enlace:'https://graduacao.fflch.usp.br/descricao-do-curso'},
]);
