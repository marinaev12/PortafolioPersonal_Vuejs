<script setup>
import proyecto1 from '/src/assets/game1.svg';
import proyecto2 from '/src/assets/game1.svg';
import proyecto3 from '/src/assets/tienda.svg';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Calculadora de Ranking Partidas ",
        descripcion: "Calculadora de Ranking para Partidas de juegos online con JavaScript.",
        githubLink: "https://github.com/evmarina12/desafio-projeto-2"
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Clasificación de heroes",
        descripcion: "Clasificación de Heroes para juegos online.                           ",
        githubLink: "https://github.com/evmarina12/desafio-projeto-3/blob/main/src/index.js"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Website tienda WWWapas",
        descripcion: "Construcción de un website con HTML y CSS.",
        githubLink: "https://github.com/evmarina12/website-wwwapas"
    },
